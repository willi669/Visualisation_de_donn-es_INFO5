...
#---------------------------------------
tailleLongitudeArpege = 720 # A MODIFIER SUIVANT LA TAILLE DE LA GRILLE DE DONNEES
tailleLatitudeArpege = 361
#---------------------------------------
MonEchelle = 0.5 # REGLAGE DE LA TAILLE DE L IMAGE FINALE

renderView1.ViewSize = [(int) (tailleLongitudeArpege*MonEchelle),(int) (tailleLatitudeArpege*MonEchelle)]
