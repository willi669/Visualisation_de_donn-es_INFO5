...
#---------------------------------------
tailleLongitudeArome = 801 # A MODIFIER SUIVANT LA TAILLE DE LA GRILLE DE DONNEES
tailleLatitudeArome = 601
#---------------------------------------
MonEchelle = 0.5 # REGLAGE DE LA TAILLE DE L IMAGE FINALE

renderView1.ViewSize = [(int) (tailleLongitudeArome*MonEchelle),(int) (tailleLatitudeArome*MonEchelle)]
