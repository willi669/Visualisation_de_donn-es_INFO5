...
#---------------------------------------
tailleLongitudeArpegeHD = 741 # A MODIFIER SUIVANT LA TAILLE DE LA GRILLE DE DONNEES
tailleLatitudeArpegeHD = 521
#---------------------------------------
MonEchelle = 0.5 # REGLAGE DE LA TAILLE DE L IMAGE FINALE

renderView1.ViewSize = [(int) (tailleLongitudeArpegeHD*MonEchelle),(int) (tailleLatitudeArpegeHD*MonEchelle)]
