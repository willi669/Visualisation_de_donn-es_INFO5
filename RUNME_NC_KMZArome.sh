...
DateDeLaPrevision=`python PYTHON/DateDeLaPrevisionArome.py $1`
FinDeLaPrevision=`python PYTHON/FinDeLaPrevisionArome.py $1`
DateDuRun=`python PYTHON/DateDuRunArome.py $1`
...
if [ -e KML/IMAGES/$NomDuFichierMeteoFrance.nc.png ]; then
	...
	/home/willeiam/ParaView-5.8.1-MPI-Linux-Python2.7-64bit/bin/pvpython --force-offscreen-rendering PYTHON/VisuAvecTemperatureArome.py DATA/$NomDuFichierMeteoFrance.nc
...
echo
cat KML/templateSpanKMZArome.kml | sed "s/ICILEFICHIER/$NomDuFichierMeteoFrance.nc.png/g" > tmp.kml
