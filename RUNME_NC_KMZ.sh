...
#	wgrib2_execbin/wgrib2 DATA/$NomDuFichierMeteoFrance -match ":TMP:" -netcdf DATA/$NomDuFichierMeteoFrance.nc
...
if [ -e KML/IMAGES/$NomDuFichierMeteoFrance.nc.png ]; then
	...
	pvpython --force-offscreen-rendering PYTHON/VisuAvecTemperatureAromeHD.py DATA/$NomDuFichierMeteoFrance.nc
...
echo
cat KML/templateSpanKMZAromeHD.kml | sed "s/ICILEFICHIER/$NomDuFichierMeteoFrance.nc.png/g" > tmp.kml
